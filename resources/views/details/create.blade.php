                ...
                <div class="card-body">
                    <form class="row " action="/details/insert" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="fname" id="firstname" class="form-control text-capitalize{{ $errors->has('firstname') ? ' is-invalid' : '' }}" id="firstname">
                            @error('firstname')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="lname" id="lastname" class="form-control text-capitalize{{ $errors->has('lastname') ? ' is-invalid' : '' }}" id="lastname">
                            @error('lastname')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
